...
class DetailPeralatanActivity : AppCompatActivity() {
    ...
    private lateinit var modelPeralatan: ModelPeralatan
    private var strNamaAlat: String? = null
    private var strDeskripsi: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (modelPeralatan != null) {
            ...
            binding.tvDetailAlat.text = strDeskripsi
        }
    }
